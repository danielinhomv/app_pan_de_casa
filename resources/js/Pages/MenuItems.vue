...
<template>
    ...
    <div class="hidden sm:flex sm:ms-10 items-center space-x-4">
        ...
        <template v-for="item in itemsVisibles" :key="item.id">
            ...
            <!-- Sin hijos -->
            <NavLink
                v-if="!item.children?.length && routeExists(item.route)"
        ...
        <div v-if="hayMas" ref="dropdownRef" class="relative">
            ...
            >
                ...
                Más
                <svg class="size-3 transition-transform duration-200" :class="{ 'rotate-180': mostrarMas }" fill="currentColor" viewBox="0 0 20 20">
                    <path fill-rule="evenodd" d="M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z" clip-rule="evenodd" />
                </svg>
            </button>
            ...
            >
                <div v-show="mostrarMas" class="absolute left-0 top-full mt-2 w-56 rounded-xl border border-gray-100 bg-white shadow-xl z-50">
