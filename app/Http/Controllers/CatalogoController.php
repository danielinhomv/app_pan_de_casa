...
class CatalogoController extends Controller
{
     ...
     */ public function confirmar(Request $request)
    {
        $request->validate([
            ...
            'tipo_pago'      => 'required|string|in:qr,efectivo,transferencia,tarjeta',
        ...
        try {
            ...
            // ── CAMBIO: Validar stock disponible ANTES de crear cualquier registro ──
            // Calculamos stock real = SUM(entradas) - SUM(salidas) por producto.
            // Si algún producto no tiene stock suficiente, abortamos todo con rollback.
            $erroresStock = [];
